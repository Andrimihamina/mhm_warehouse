<?php
    ...
    /* =============== APPICATION OBLIGATORY VARIABLE=====================*/
        $application= strip_tags($_POST["application"]);
        if($application=="Choose..."){$_SESSION["error_incomplet"] =[];}

    /* =============== CLASSIFCAIION 0 OBLIGATORY VARIABLE======================*/
        $classification_0= strip_tags($_POST["classification_0"]);
        if($classification_0=="Choose..."){$_SESSION["error_incomplet"] =["Classification Empty"];}
