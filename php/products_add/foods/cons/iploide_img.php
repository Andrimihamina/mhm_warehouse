<?php
    ...
    switch($infos["mime"]){
        case "image/png":
            ...
            imagepng($nouvelleImage, __DIR__ . "../../../../../../warehouse_img/img/cons_foo_img/cons_foo-img-". $file_name);
            break;
        case "image/jpeg":
            //On enregistre l'image
            imagejpeg($nouvelleImage, __DIR__ . "../../../../../../warehouse_img/img/cons_foo_img/cons_foo-img-". $file_name);
            break;     
    }
