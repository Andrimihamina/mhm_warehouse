<?php
    ...
    switch($infos["mime"]){
        case "image/png":
            ...
            imagepng($nouvelleImage, __DIR__ . "../../../../../../warehouse_img/img/cons_foo_img/cons_foo-img-". $id_code . $file_name);
            break;
        case "image/jpeg":
            //On enregistre l'image
            imagejpeg($nouvelleImage, __DIR__ . "../../../../../../warehouse_img/img/cons_foo_img/cons_foo-img-". $id_code . $file_name);
            break;     
    }
...
$file_name = "cons_foo-img-". $id_code . $file_name;
require_once ("../../sql/functions/products_edit/foods/consumables/img.php");
