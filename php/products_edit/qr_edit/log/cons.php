...
// LOCATION
    ...
    require_once ("../../sql/functions/products_edit/logistics/consumables/location.php");
...
// QUANTITE
    ...
    require_once ("../../sql/functions/products_edit/logistics/consumables/quantity.php");
