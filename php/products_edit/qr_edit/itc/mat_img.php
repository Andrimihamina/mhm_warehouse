<?php
    ...
    switch($infos["mime"]){
        case "image/png":
            ...
            imagepng($nouvelleImage, __DIR__ . "../../../../../../warehouse_img/img/mat_itc_img/mat_itc-img-". $id_code . $file_name);
            break;
        case "image/jpeg":
            //On enregistre l'image
            imagejpeg($nouvelleImage, __DIR__ . "../../../../../../warehouse_img/img/mat_itc_img/mat_itc-img-". $id_code . $file_name);
            break;     
    }
...
$file_name = "mat_itc-img-". $id_code . $file_name;
require_once ("../../sql/functions/products_edit/itc/materials/img.php");
