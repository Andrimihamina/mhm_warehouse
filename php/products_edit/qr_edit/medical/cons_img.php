<?php
    ...
    switch($infos["mime"]){
        case "image/png":
            ...
            imagepng($nouvelleImage, __DIR__ . "../../../../../../warehouse_img/img/cons_med_img/Cons_med-img-" . $id_code . $file_name);
            break;
        case "image/jpeg":
            //On enregistre l'image
            imagejpeg($nouvelleImage, __DIR__ . "../../../../../../warehouse_img/img/cons_med_img/Cons_med-img-". $id_code . $file_name);
            break;     
    }
...
$file_name = "Cons_med-img-". $id_code . $file_name;
require_once ("../../sql/functions/products_edit/medicals/consumables/img.php");
