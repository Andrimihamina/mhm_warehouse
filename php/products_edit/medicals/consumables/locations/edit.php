...
foreach( $_POST as $cle =>$value )
{
    if ($value == "edit"){
        ...
        // LOCATION 1
        $tbl_location_1 = "cos_location";
        $colums_location_1 = "id_location";
        // LOCATION 2
        $tbl_location_2 = "cos_sublocation";
        $colums_location_2 = "id_sub_loc";
        // LOCATION 3
        $tbl_location_3 = "cos_subsublocation";
        $colums_location_3 = "id_subsubloc";

        /* ===================== APPLICATION AFFICHE=========================*/
        include_once ("../../php/products_add/add/5_b_location.php");

        require_once ("../../sql/functions/products_edit/medicals/consumables/location.php");
                
        header("Location: ../../Layout/Products_edit/edit_cons_med_c_locations.php");
    }
}
