...
foreach( $_POST as $cle =>$value )
{
    if ($value == "edit"){
        ...
        // LOCATION 1
        $tbl_location_1 = "mat_location_foo";
        $colums_location_1 = "id_location";
        // LOCATION 2
        $tbl_location_2 = "mat_sublocation_foo";
        $colums_location_2 = "id_sub_loc";
        // LOCATION 3
        $tbl_location_3 = "mat_subsublocation_foo";
        $colums_location_3 = "id_subsubloc";

        /* ===================== APPLICATION AFFICHE=========================*/
        include_once ("../../php/products_add/add/5_b_location.php");

        require_once ("../../sql/functions/products_edit/foods/materials/location.php");
                
        header("Location: ../../Layout/Products_edit/edit_mat_foo_c_locations.php");
    }
}
