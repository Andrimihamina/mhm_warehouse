...
*/
        ...
        $sql_flux_out_update_qt_stock = "UPDATE `mat_log_quantity` SET `stock` = '$soustract' WHERE `mat_log_quantity`.`id_mat_log` = '$id_mat_log'";
        ...
        $sql_flux_out_update_qt_stock_in = "UPDATE `mat_log_quantity` SET `stock_out` = '$add_out_stock' WHERE `mat_log_quantity`.`id_mat_log` = '$id_mat_log'";
