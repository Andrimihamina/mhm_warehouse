...
*/
        ...
        */                        
        ...
        $sql_flux_out_update_qt_stock = "UPDATE `cons_tec_quantity` SET `stock` = '$soustract' WHERE `cons_tec_quantity`.`id_cons_tec` = '$id_cons_tec'";
        ...
        $sql_flux_out_update_qt_stock_in = "UPDATE `cons_tec_quantity` SET `stock_out` = '$add_out_stock' WHERE `cons_tec_quantity`.`id_cons_tec` = '$id_cons_tec'";
