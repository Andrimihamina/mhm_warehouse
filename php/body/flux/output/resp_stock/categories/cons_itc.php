...
*/
        ...
        */                        
        ...
        $sql_flux_out_update_qt_stock = "UPDATE `cons_itc_quantity` SET `stock` = '$soustract' WHERE `cons_itc_quantity`.`id_cons_itc` = '$id_cons_itc'";
        ...
        $sql_flux_out_update_qt_stock_in = "UPDATE `cons_itc_quantity` SET `stock_out` = '$add_out_stock' WHERE `cons_itc_quantity`.`id_cons_itc` = '$id_cons_itc'";
