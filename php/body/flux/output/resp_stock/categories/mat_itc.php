...
*/
        ...
        $sql_flux_out_update_qt_stock = "UPDATE `mat_itc_quantity` SET `stock` = '$soustract' WHERE `mat_itc_quantity`.`id_mat_itc` = '$id_mat_itc'";
        ...
        $sql_flux_out_update_qt_stock_in = "UPDATE `mat_itc_quantity` SET `stock_out` = '$add_out_stock' WHERE `mat_itc_quantity`.`id_mat_itc` = '$id_mat_itc'";
