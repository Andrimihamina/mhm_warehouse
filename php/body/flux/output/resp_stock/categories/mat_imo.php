...
*/
        ...
        $sql_flux_out_update_qt_stock = "UPDATE `mat_imo_quantity` SET `stock` = '$soustract' WHERE `mat_imo_quantity`.`id_mat_imo` = '$id_mat_imo'";
        ...
        $sql_flux_out_update_qt_stock_in = "UPDATE `mat_imo_quantity` SET `stock_out` = '$add_out_stock' WHERE `mat_imo_quantity`.`id_mat_imo` = '$id_mat_imo'";
