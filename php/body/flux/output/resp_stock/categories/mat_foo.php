...
*/
        ...
        $sql_flux_out_update_qt_stock = "UPDATE `mat_foo_quantity` SET `stock` = '$soustract' WHERE `mat_foo_quantity`.`id_mat_foo` = '$id_mat_foo'";
        ...
        $sql_flux_out_update_qt_stock_in = "UPDATE `mat_foo_quantity` SET `stock_out` = '$add_out_stock' WHERE `mat_foo_quantity`.`id_mat_foo` = '$id_mat_foo'";
