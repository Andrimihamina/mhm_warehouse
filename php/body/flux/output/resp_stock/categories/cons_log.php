...
*/
        ...
        */                        
        ...
        $sql_flux_out_update_qt_stock = "UPDATE `cons_log_quantity` SET `stock` = '$soustract' WHERE `cons_log_quantity`.`id_cons_log` = '$id_cons_log'";
        ...
        $sql_flux_out_update_qt_stock_in = "UPDATE `cons_log_quantity` SET `stock_out` = '$add_out_stock' WHERE `cons_log_quantity`.`id_cons_log` = '$id_cons_log'";
