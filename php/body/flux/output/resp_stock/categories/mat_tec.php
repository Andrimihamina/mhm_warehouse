<?php
    ...
    if($abbrev_value_indentif == "MAT-TEC-"){
...
*/
        ...
        $sql_flux_out_update_qt_stock = "UPDATE `mat_tec_quantity` SET `stock` = '$soustract' WHERE `mat_tec_quantity`.`id_mat_tec` = '$id_mat_tec'";
        ...
        $sql_flux_out_update_qt_stock_in = "UPDATE `mat_tec_quantity` SET `stock_out` = '$add_out_stock' WHERE `mat_tec_quantity`.`id_mat_tec` = '$id_mat_tec'";
