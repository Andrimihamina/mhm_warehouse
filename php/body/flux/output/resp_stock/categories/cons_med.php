...
*/
        ...
        */                        
        ...
        $sql_flux_out_update_qt_stock = "UPDATE `cons_med_quantity` SET `stock` = '$soustract' WHERE `cons_med_quantity`.`id_cons_med` = '$id_cons_med'";
        ...
        $sql_flux_out_update_qt_stock_in = "UPDATE `cons_med_quantity` SET `stock_out` = '$add_out_stock' WHERE `cons_med_quantity`.`id_cons_med` = '$id_cons_med'";
...
*/
        ...
        $sql_flux_out_update_qt_general = "UPDATE `inventories` SET `general` = '$soustract_patient_system' WHERE `inventories`.`id_cons_med` = '$id_cons_med'";
        ...
        include("../../../../../php/body/flux/output/resp_stock/categories/patients_system_service_cons_med.php");
