...
*/
        ...
        */                        
        ...
        $sql_flux_in_update_qt_stock = "UPDATE `mat_imo_quantity` SET `stock` = '$addstock' WHERE `mat_imo_quantity`.`id_mat_imo` = '$id_mat_imo'";
        ...
        $sql_flux_in_update_qt_stock_in = "UPDATE `mat_imo_quantity` SET `stock_in` = '$add_in_stock' WHERE `mat_imo_quantity`.`id_mat_imo` = '$id_mat_imo'";
