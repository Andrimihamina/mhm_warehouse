...
*/
        ...
        */                        
        ...
        $sql_flux_in_update_qt_stock = "UPDATE `mat_log_quantity` SET `stock` = '$addstock' WHERE `mat_log_quantity`.`id_mat_log` = '$id_mat_log'";
        ...
        $sql_flux_in_update_qt_stock_in = "UPDATE `mat_log_quantity` SET `stock_in` = '$add_in_stock' WHERE `mat_log_quantity`.`id_mat_log` = '$id_mat_log'";
