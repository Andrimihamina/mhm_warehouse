...
*/
        ...
        */                        
        ...
        $sql_flux_in_update_qt_stock = "UPDATE `mat_itc_quantity` SET `stock` = '$addstock' WHERE `mat_itc_quantity`.`id_mat_itc` = '$id_mat_itc'";
        ...
        $sql_flux_in_update_qt_stock_in = "UPDATE `mat_itc_quantity` SET `stock_in` = '$add_in_stock' WHERE `mat_itc_quantity`.`id_mat_itc` = '$id_mat_itc'";
