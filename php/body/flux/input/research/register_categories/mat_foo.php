...
*/
        ...
        */                        
        ...
        $sql_flux_in_update_qt_stock = "UPDATE `mat_foo_quantity` SET `stock` = '$addstock' WHERE `mat_foo_quantity`.`id_mat_foo` = '$id_mat_foo'";
        ...
        $sql_flux_in_update_qt_stock_in = "UPDATE `mat_foo_quantity` SET `stock_in` = '$add_in_stock' WHERE `mat_foo_quantity`.`id_mat_foo` = '$id_mat_foo'";
