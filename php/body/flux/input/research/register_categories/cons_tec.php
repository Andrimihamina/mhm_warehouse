...
*/
        ...
        */                        
        ...
        $sql_flux_in_update_qt_stock = "UPDATE `cons_tec_quantity` SET `stock` = '$addstock' WHERE `cons_tec_quantity`.`id_cons_tec` = '$id_cons_tec'";
        ...
        */                        
            ...
            $sql_flux_in_update_qt_stock_in = "UPDATE `cons_tec_quantity` SET `stock_in` = '$add_in_stock' WHERE `cons_tec_quantity`.`id_cons_tec` = '$id_cons_tec'";
