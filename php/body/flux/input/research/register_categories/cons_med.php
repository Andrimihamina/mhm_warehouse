...
*/
        ...
        */                        
        ...
        $sql_flux_in_update_qt_stock = "UPDATE `cons_med_quantity` SET `stock` = '$addstock' WHERE `cons_med_quantity`.`id_cons_med` = '$id_cons_med'";
        ...
        */                        
            ...
            $sql_flux_in_update_qt_stock_in = "UPDATE `cons_med_quantity` SET `stock_in` = '$add_in_stock' WHERE `cons_med_quantity`.`id_cons_med` = '$id_cons_med'";
