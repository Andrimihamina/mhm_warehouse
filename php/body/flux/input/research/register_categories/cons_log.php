...
*/
        ...
        */                        
        ...
        $sql_flux_in_update_qt_stock = "UPDATE `cons_log_quantity` SET `stock` = '$addstock' WHERE `cons_log_quantity`.`id_cons_log` = '$id_cons_log'";
        ...
        */                        
            ...
            $sql_flux_in_update_qt_stock_in = "UPDATE `cons_log_quantity` SET `stock_in` = '$add_in_stock' WHERE `cons_log_quantity`.`id_cons_log` = '$id_cons_log'";
