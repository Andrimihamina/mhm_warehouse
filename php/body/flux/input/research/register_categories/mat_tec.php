...
*/
        ...
        */                        
        ...
        $sql_flux_in_update_qt_stock = "UPDATE `mat_tec_quantity` SET `stock` = '$addstock' WHERE `mat_tec_quantity`.`id_mat_tec` = '$id_mat_tec'";
        ...
        $sql_flux_in_update_qt_stock_in = "UPDATE `mat_tec_quantity` SET `stock_in` = '$add_in_stock' WHERE `mat_tec_quantity`.`id_mat_tec` = '$id_mat_tec'";
