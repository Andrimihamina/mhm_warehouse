...
*/
        ...
        */                        
        ...
        $sql_flux_in_update_qt_stock = "UPDATE `cons_foo_quantity` SET `stock` = '$addstock' WHERE `cons_foo_quantity`.`id_cons_foo` = '$id_cons_foo'";
        ...
        */                        
            ...
            $sql_flux_in_update_qt_stock_in = "UPDATE `cons_foo_quantity` SET `stock_in` = '$add_in_stock' WHERE `cons_foo_quantity`.`id_cons_foo` = '$id_cons_foo'";
