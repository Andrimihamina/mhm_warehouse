...
$sql_1 = "SELECT `categories`,`id_abrev_code`,`purchase_date` , `descriptions`, `quantity_added`, `purchase_price` FROM `flux_in` WHERE id_in ='$id_code_in'";
...
//telecharger
$pdf->Output('F', "../../../../../img/flux/input/$name"); 
