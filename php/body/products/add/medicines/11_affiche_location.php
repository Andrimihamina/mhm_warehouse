<?php
  ...
  if($_POST["location_0"]!= "Choose Location"){
     ...
     $sql_affiche_location_0= "SELECT * FROM `med_location` WHERE `id_location` = $location_0";
  ...
  if($_POST["location_1"]!= "Choose Sub-Location"){
   ...
   $sql_affiche_location_1= "SELECT * FROM `med_sublocation` WHERE `id_sub_loc` = $location_1";
  ...
  if($_POST["location_2"]!= "Choose Sub-Sub-Location"){
   ...
   $sql_affiche_location_2= "SELECT * FROM `med_subsublocation` WHERE `id_subsubloc` = $location_2";
