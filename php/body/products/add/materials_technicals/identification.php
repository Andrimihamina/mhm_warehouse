...
if(
    isset(
            ...
            */
            ...
            ========================= ABREVIATION =========================
            */
              $mat_tec_abrev = substr($Name,0,5);
              $mat_tec_abrev = strtoupper($mat_tec_abrev);
  
            // COUNT NOMBRE D'ABREVIATION
              $check_nbr_mat_tec_abrev= mysqli_query($dbc,"SELECT * FROM `mat_tec_id` WHERE `mat_tec_abrev` ='$mat_tec_abrev'");
              $checkrows_nbr_med_mat_tec_abrev=mysqli_num_rows($check_nbr_mat_tec_abrev);
  
              if($checkrows_nbr_med_mat_tec_abrev > 0)
              {$mat_tec_nbr_abrev = $checkrows_nbr_med_mat_tec_abrev + 1;}
              else 
              { $mat_tec_nbr_abrev = 1;}
            ...
            */
            //NOMBRE DE CARACTER DANS LE COUNT DE L'ABREVIATION
              $nb_char = strlen($mat_tec_nbr_abrev);
              switch($nb_char){
                  case 1 :
                      $nb_chars = "-00";
                      break;
          ...
          // COUNT NOMBRE NAME
            $sql_Name_check = mysqli_query($dbc,"SELECT * FROM `mat_tec_id` WHERE `name_check` ='$Name_check'");
          ...
          */
          //NOMBRE DE CARACTER DANS LE COUNT DE L'ABREVIATION
            ...
            // ID CODE MATERIALS TECHNICALS
              $id_code_mat_tec= "MAT-TEC" . "-" . $mat_tec_abrev . $nb_chars . $mat_tec_nbr_abrev;
            ...
            */
            $check_mat_seral_number= mysqli_query($dbc,"SELECT * FROM `mat_tec_id` WHERE `sereal_number` ='$sereal_number' AND `name_check` ='$Name_check'");
            ...
            else
            {
              ...
              $sql_mat_tec_id_adhesive = "INSERT INTO `mat_tec_id` (
                /*ID PRIMARY*/
                `id`, 
                /*CREATE*/
                `created_date`, 
                /*ID ABREV*/
                `mat_tec_abrev`, `mat_tec_nbr_abrev`, `id_code_mat_tec`,
                /*NAME*/
                `Descriptions`, 
                 /*NAME CHECK*/
                 `name_check`, 
              ...
              $query_mat_tec_id_adhesive = $db->prepare($sql_mat_tec_id_adhesive);
              //On execute la requete
             $query_mat_tec_id_adhesive->execute();
            
             //On recupere l'id de l'article
              $mat_tec_id = $db->lastInsertId();
