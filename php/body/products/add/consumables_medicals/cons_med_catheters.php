              ...
              */
                ...
                // print_r( "$intravenous");
                  $Name_catheters = "Catheters Intravenous";
                   ...
                   // GAUZES
                   $sizes_gauge_cath= strip_tags($_POST["sizes_gauge_cath_intravenous"]);
                   ...
                   // COLOR             
                   $sizes_color_cath= strip_tags($_POST["sizes_color_cath_intravenous"]);
              ...
              */
              case "$intraarterial" :
                // print_r( "$intraarterial");
                  ...
                  // GAUZES
                  $sizes_gauge_cath= strip_tags($_POST["sizes_gauge_cath_intraarterial"]);
                  ...
                  // COLOR             
                  $sizes_color_cath= strip_tags($_POST["sizes_color_cath_intraarterial"]);
                  if($sizes_color_cath != "Chooses Sizes..."){
                    $sizes_color = $sizes_color_cath;
                  }else{
                    $sizes_color = "NULL";
              ...
              case "$intraosseous" :
                // print_r( "$intraosseous");
                  $Name_catheters = "Catheters Intraosseous"; 
                   ...
                   /*================TYPES====================*/
                   $sizes_age_cath= strip_tags($_POST["sizes_age_cath"]);
                   $types_1 = $sizes_age_cath;
                   $types_1_bd = "NULL";
                   ...
                   // GAUZES
                   $sizes_gauge_cath= strip_tags($_POST["sizes_gauge_cath_intraosseous"]);
                   ...
                   // COLOR             
                   $sizes_color_cath= strip_tags($_POST["sizes_color_cath_intraosseous"]);
                   if($sizes_color_cath != "Chooses Sizes..."){
                     $sizes_color = $sizes_color_cath;
                   }else{
                     $sizes_color = "NULL";
              ...
              */
              case "$central" :
                // print_r( "$central");
                  ...
                  // GAUZES
                  $sizes_gauge_cath= strip_tags($_POST["sizes_gauge_cath_central"]);
                  ...
                  // COLOR             
                  $sizes_color_cath= strip_tags($_POST["sizes_color_cath_central"]);
                  if($sizes_color_cath != "Chooses Sizes..."){
                    $sizes_color = $sizes_color_cath;
                  }else{
                    $sizes_color = "NULL";
              ...
              */
              case "$umbilical" :
                // print_r( "$umbilical");
                  ...
                  // GAUZES
                  $sizes_gauge_cath= strip_tags($_POST["sizes_gauge_cath_umbilical"]);
                  ...
                  // COLOR             
                  $sizes_color_cath= strip_tags($_POST["sizes_color_cath_umbilical"]);
                  if($sizes_color_cath != "Chooses Sizes..."){
                    $sizes_color = $sizes_color_cath;
                  }else{
                    $sizes_color = "NULL";
              ...
              case "$suction" :
                // print_r( "$suction");
                  ...
                  $types_2_bd = $fingertips_cath;
                   ...
                   // CHARRIERE
                   $sizes_charriere_cath= strip_tags($_POST["sizes_charriere_cath_suction"]);
                   ...
                   // COLOR             
                   $sizes_color_cath= strip_tags($_POST["sizes_color_cath_suction"]);
                   if($sizes_color_cath != "Chooses Sizes..."){
                     $sizes_color = $sizes_color_cath;
                   }else{
                     $sizes_color = "NULL";
              ...
              */
              case "$urinary" :
                // print_r( "$urinary");
                  ...
                  $sizes_specific = "NULL";
                  // CHARRIERE
                  $sizes_charriere_cath= strip_tags($_POST["sizes_charriere_cath_urinary"]);
                   if($sizes_charriere_cath != "Chooses Sizes..."){
                    $sizes_charriere = $sizes_charriere_cath;
                    }else{
                      $sizes_charriere = "NULL";
                  ...
                  // COLOR             
                  $sizes_color_cath= strip_tags($_POST["sizes_color_cath_urinary"]);
                  if($sizes_color_cath != "Chooses Sizes..."){
                    $sizes_color = $sizes_color_cath;
                  }else{
                    $sizes_color = "NULL";
