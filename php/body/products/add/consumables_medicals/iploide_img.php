<?php
    if(!empty($_FILES)){
    $file_name = $_FILES["cons_img"]["name"];
    $file_tmp_name = $_FILES["cons_img"]["tmp_name"];
    ...
    switch($infos["mime"]){
        case "image/png":
            ...
            imagepng($nouvelleImage, __DIR__ . "/../../../../../img/cons_med_img/consumable-img-". $file_name);
            break;
        case "image/jpeg":
            //On enregistre l'image
            imagejpeg($nouvelleImage, __DIR__ . "/../../../../../img/cons_med_img/consumable-img-". $file_name);
            break;     
    }
