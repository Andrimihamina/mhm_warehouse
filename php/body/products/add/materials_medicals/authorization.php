...
//NO MEDICAL STORAGE
        ...
        */
        $sql_authorization_active = "INSERT INTO `mat_med_aut_active` 
        (`id`, `id_mat_med`, 
        /*Mobil Medical*/
       ...
       */
      $sql_authorization_passive = "INSERT INTO `mat_med_aut_passive` 
      (`id`, `id_mat_med`,
      /*ADMIN*/
     ...
     */
    $sql_authorization_temporary = "INSERT INTO `mat_med_aut_temporary` 
    (`id`, `id_mat_med`, 
   `new_bulding`, 
