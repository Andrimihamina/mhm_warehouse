...
//NO MEDICAL STORAGE
        ...
        */
        $sql_cons_log_authorization_active = "INSERT INTO `cons_log_aut_active` 
        (`id`, `id_cons_log`, 
        /*Mobil Medical*/
        ...
        $query_cons_log_authorization_active= $db->prepare($sql_cons_log_authorization_active);
        //On execute la requete

       $query_cons_log_authorization_active->execute();
       /*
       =================== AUTORIZATION PASSIVE ===============================
       */
      $sql_cons_log_authorization_passive = "INSERT INTO `cons_log_aut_passive` 
      (`id`, `id_cons_log`,
      /*ADMIN*/
      ...
      //On prerare la requete
      $query_cons_log_authorization_passive= $db->prepare($sql_cons_log_authorization_passive);
      //On execute la requete

     $query_cons_log_authorization_passive->execute();
     /*
                =====================0 AUTORIZATION TEMPORARY ========================
     */
    $sql_cons_log_authorization_temporary = "INSERT INTO `cons_log_aut_temporary` 
    (`id`, `id_cons_log`, 
   `new_bulding`, 
    ...
    //On prerare la requete
    $query_cons_log_authorization_temporary= $db->prepare($sql_cons_log_authorization_temporary);
    //On execute la requete

   $query_cons_log_authorization_temporary->execute();
