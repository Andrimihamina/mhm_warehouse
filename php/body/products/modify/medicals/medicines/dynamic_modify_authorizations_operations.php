...
if(!empty($_POST)){
    ...
    //POST n'est pas vide, on verifier que toutes les donnes sont presents
            ...
            ======================== INSERTION FROM =============
            */
            $sql_medicine_auth = "UPDATE `medicine_authorizations_passive` SET `Operation_Cleaning` = '$Operation_Cleaning', `Operation_Cooking` = '$Operation_Cooking', `Operation_Laundry` = '$Operation_Laundry' WHERE `medicine_authorizations_passive`.`id_med` = '$id'";
