...
if(!empty($_POST)){
    ...
    //POST n'est pas vide, on verifier que toutes les donnes sont presents
            ...
            ======================== INSERTION FROM =============
            */
            $sql_medicine_auth = "UPDATE `medicine_authorizations_passive` SET `technical_technical` = '$technical_technical', `technical_Biomed` = '$technical_Biomed', `technical_Mechanical` = '$technical_Mechanical' WHERE `medicine_authorizations_passive`.`id_med` = '$id'";
