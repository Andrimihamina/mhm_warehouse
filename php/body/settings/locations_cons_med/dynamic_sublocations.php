...
if(!empty($_POST)){
    ...
    if(
        ...
        && !empty($_POST["sublocation_definitions"]) && !empty($_POST["sublocation_descriptions"])
            ...
            $check_sublocations= mysqli_query($dbc,"SELECT * FROM `cos_sublocation` WHERE `sublocation_descriptions` ='$sublocation_descriptions'");
            ...
            //On ecrit la requete
            $sql_settings_sublocation= "INSERT INTO `cos_sublocation` (`sublocation_descriptions`, `sublocation_definitions`) VALUES ('$sublocation_descriptions', '$sublocation_definitions')";
