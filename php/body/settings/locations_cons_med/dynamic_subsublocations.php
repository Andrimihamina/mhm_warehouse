...
if(!empty($_POST)){
    ...
    if(
        ...
        && !empty($_POST["subsublocation_definitions"]) && !empty($_POST["subsublocation_descriptions"])
            ...
            $check_subsublocations= mysqli_query($dbc,"SELECT * FROM `cos_subsublocation` WHERE `subsublocation_descriptions` ='$subsublocation_descriptions'");
            ...
            //On ecrit la requete
            $sql_settings_subsublocation= "INSERT INTO `cos_subsublocation` (`subsublocation_descriptions`, `subsublocation_definitions`) VALUES ('$subsublocation_descriptions', '$subsublocation_definitions')";
