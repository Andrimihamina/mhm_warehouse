...
if(!empty($_POST)){
    ...
    if(
        ...
        && !empty($_POST["units_description"]) && !empty($_POST["units_definition"])
            ...
            $check_units= mysqli_query($dbc,"SELECT * FROM `cons_charrieres` WHERE `charrieres_descriptions` ='$units_description'");
            ...
            //On ecrit la requete
            $sql_settings_units= "INSERT INTO `cons_charrieres` (`charrieres_descriptions`, `charrieres_definitions`) VALUES ('$units_description', '$units_definition')";
            ...
            //On connectera l'utilisateur
             ...
             $_SESSION["charrieres"] = [
                "id_charrieres" => $id_units,
                "charrieres_desciptions" => $units_desciption,
                "charrieres_definitions" => $units_definition,
            ];
