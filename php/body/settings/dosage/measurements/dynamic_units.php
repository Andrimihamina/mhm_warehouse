...
if(!empty($_POST)){
    ...
    if(
        ...
        && !empty($_POST["units_description"]) && !empty($_POST["units_definition"])
            ...
            $check_units= mysqli_query($dbc,"SELECT * FROM `cons_measurs` WHERE `measurs_descriptions` ='$units_description'");
            ...
            //On ecrit la requete
            $sql_settings_units= "INSERT INTO `cons_measurs` (`measurs_descriptions`, `measurs_definitions`) VALUES ('$units_description', '$units_definition')";
            ...
            //On connectera l'utilisateur
             ...
             $_SESSION["measurs"] = [
                "id_measurs" => $id_units,
                "measurs_desciption" => $units_desciption,
                "measurs_definition" => $units_definition,
            ];
