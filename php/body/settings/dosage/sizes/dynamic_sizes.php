...
if(!empty($_POST)){
    ...
    if(
        ...
        && !empty($_POST["units_description"]) && !empty($_POST["units_definition"])
            ...
            $check_units= mysqli_query($dbc,"SELECT * FROM `cons_sizes` WHERE `sizes_descriptions` ='$units_description'");
            ...
            //On ecrit la requete
            $sql_settings_units= "INSERT INTO `cons_sizes` (`sizes_descriptions`, `sizes_definitions`) VALUES ('$units_description', '$units_definition')";
            ...
            //On connectera l'utilisateur
             ...
             $_SESSION["sizes"] = [
                "id_sizes" => $id_units,
                "sizes_desciptions" => $units_desciption,
                "sizes_definitions" => $units_definition,
            ];
