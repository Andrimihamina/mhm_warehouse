...
if(!empty($_POST)){
    ...
    if(
        ...
        && !empty($_POST["units_description"]) && !empty($_POST["units_definition"])
            ...
            $check_units= mysqli_query($dbc,"SELECT * FROM `cons_gauss` WHERE `gauss_descriptions` ='$units_description'");
            ...
            //On ecrit la requete
            $sql_settings_units= "INSERT INTO `cons_gauss` (`gauss_descriptions`, `gauss_definitions`) VALUES ('$units_description', '$units_definition')";
            ...
            //On connectera l'utilisateur
             ...
             $_SESSION["gauss"] = [
                "id_gauss" => $id_units,
                "gauss_desciptions" => $units_desciption,
                "gauss_definitions" => $units_definition,
            ];
