...
if(!empty($_POST)){
    ...
    if(
        ...
        && !empty($_POST["units_description"]) && !empty($_POST["units_definition"])
            ...
            $check_units= mysqli_query($dbc,"SELECT * FROM `cons_colors` WHERE `colors_descriptions` ='$units_description'");
            ...
            //On ecrit la requete
            $sql_settings_units= "INSERT INTO `cons_colors` (`colors_descriptions`, `colors_definitions`) VALUES ('$units_description', '$units_definition')";
            ...
            //On connectera l'utilisateur
             ...
             $_SESSION["colors"] = [
                "id_colors" => $id_units,
                "colors_desciptions" => $units_desciption,
                "colors_definitions" => $units_definition,
            ];
