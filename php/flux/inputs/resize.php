...
if(!empty($_FILES)){
    ...
    switch($infos["mime"]){
        case "image/png":
            ...
            imagepng($nouvelleImage, __DIR__ . "/../../../img/bill_img/bill-img-". $file_name);
            break;
        case "image/jpeg":
            //On enregistre l'image
            imagejpeg($nouvelleImage, __DIR__ . "/../../../img/bill_img/bill-img-". $file_name);
            break;     
    }
...
}else{$_SESSION["error_suppliers_img"] = ["Scan bill empty"];}
}
?>