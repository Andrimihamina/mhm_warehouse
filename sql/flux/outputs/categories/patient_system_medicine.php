...
$affiche_services = $requete_services->fetch();
    ...
    $add_qt_services = $stock_services_actual_quantity + $QT;

    // UPDATE
    $sql_flux_in_update_qt= "UPDATE `inventories` SET `$services` = '$add_qt_services' WHERE `inventories`.`id_med` = '$id_med'";
