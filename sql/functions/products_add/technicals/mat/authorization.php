<?php
        ...
        */
        $sql_authorization_active = "INSERT INTO `mat_tec_aut_active` 
        (`id`, `id_mat_tec`,
        /*Mobil Medical*/
       ...
       */
      $sql_authorization_passive = "INSERT INTO `mat_tec_aut_passive` 
      (`id`, `id_mat_tec`, 
      /*ADMIN*/
     ...
     */
    $sql_authorization_temporary = "INSERT INTO `mat_tec_aut_temporary` 
    (`id`, `id_mat_tec`, 
    `new_bulding`, 
