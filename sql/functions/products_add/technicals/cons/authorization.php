<?php
        ...
        */
        $sql_authorization_active = "INSERT INTO `cons_tec_aut_active` 
        (`id`, `id_cons_tec`,
        /*Mobil Medical*/
       ...
       */
      $sql_authorization_passive = "INSERT INTO `cons_tec_aut_passive` 
      (`id`, `id_cons_tec`, 
      /*ADMIN*/
     ...
     */
    $sql_authorization_temporary = "INSERT INTO `cons_tec_aut_temporary` 
    (`id`, `id_cons_tec`, 
    `new_bulding`, 
