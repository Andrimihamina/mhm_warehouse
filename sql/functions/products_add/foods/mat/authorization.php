<?php
        ...
        */
        $sql_authorization_active = "INSERT INTO `mat_foo_aut_active` 
        (`id`, `id_mat_foo`,
        /*Mobil Medical*/
       ...
       */
      $sql_authorization_passive = "INSERT INTO `mat_foo_aut_passive` 
      (`id`, `id_mat_foo`, 
      /*ADMIN*/
     ...
     */
    $sql_authorization_temporary = "INSERT INTO `mat_foo_aut_temporary` 
    (`id`, `id_mat_foo`, 
    `new_bulding`, 
