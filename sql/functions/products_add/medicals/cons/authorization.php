<?php
        ...
        */
        $sql_authorization_active = "INSERT INTO `cons_med_aut_active` 
        (`id`, `id_cons_med`,
        /*Mobil Medical*/
       ...
       */
      $sql_authorization_passive = "INSERT INTO `cons_med_aut_passive` 
      (`id`, `id_cons_med`, 
      /*ADMIN*/
     ...
     */
    $sql_authorization_temporary = "INSERT INTO `cons_med_aut_temporary` 
    (`id`, `id_cons_med`, 
    `new_bulding`, 
