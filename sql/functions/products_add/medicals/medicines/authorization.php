<?php
        ...
        */
        $sql_medicine_authorization_active = "INSERT INTO `medicine_authorizations_active` 
        (`id`, `id_med`,
        /*Mobil Medical*/
        ...
        $query_medicine_authorization_active= $db->prepare($sql_medicine_authorization_active);
        //On execute la requete

       $query_medicine_authorization_active->execute();
       /*
       =================== AUTORIZATION PASSIVE ===============================
       */
      $sql_medicine_authorization_passive = "INSERT INTO `medicine_authorizations_passive` 
      (`id`, `id_med`, 
      /*ADMIN*/
      ...
      //On prerare la requete
      $query_medicine_authorization_passive= $db->prepare($sql_medicine_authorization_passive);
      //On execute la requete

     $query_medicine_authorization_passive->execute();
     /*
                =====================0 AUTORIZATION TEMPORARY ========================
     */
    $sql_medicine_authorization_temporary = "INSERT INTO `medicine_authorizations_temporary` 
    (`id`, `id_med`, 
    `new_bulding`, 
    ...
    //On prerare la requete
    $query_medicine_authorization_temporary= $db->prepare($sql_medicine_authorization_temporary);
    //On execute la requete

   $query_medicine_authorization_temporary->execute();
