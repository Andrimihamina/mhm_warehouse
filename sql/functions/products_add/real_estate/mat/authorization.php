<?php
        ...
        */
        $sql_authorization_active = "INSERT INTO `mat_imo_aut_active` 
        (`id`, `id_mat_imo`,
        /*Mobil Medical*/
       ...
       */
      $sql_authorization_passive = "INSERT INTO `mat_imo_aut_passive` 
      (`id`, `id_mat_imo`, 
      /*ADMIN*/
     ...
     */
    $sql_authorization_temporary = "INSERT INTO `mat_imo_aut_temporary` 
    (`id`, `id_mat_imo`, 
    `new_bulding`, 
