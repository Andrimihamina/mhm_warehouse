<?php
        ...
        */
        $sql_authorization_active = "INSERT INTO `cons_log_aut_active` 
        (`id`, `id_cons_log`,
        /*Mobil Medical*/
       ...
       */
      $sql_authorization_passive = "INSERT INTO `cons_log_aut_passive` 
      (`id`, `id_cons_log`, 
      /*ADMIN*/
     ...
     */
    $sql_authorization_temporary = "INSERT INTO `cons_log_aut_temporary` 
    (`id`, `id_cons_log`, 
    `new_bulding`, 
