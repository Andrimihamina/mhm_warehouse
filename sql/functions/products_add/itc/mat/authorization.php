<?php
        ...
        */
        $sql_authorization_active = "INSERT INTO `mat_itc_aut_active` 
        (`id`, `id_mat_itc`,
        /*Mobil Medical*/
       ...
       */
      $sql_authorization_passive = "INSERT INTO `mat_itc_aut_passive` 
      (`id`, `id_mat_itc`, 
      /*ADMIN*/
     ...
     */
    $sql_authorization_temporary = "INSERT INTO `mat_itc_aut_temporary` 
    (`id`, `id_mat_itc`, 
    `new_bulding`, 
