<?php
        ...
        */
        $sql_authorization_active = "INSERT INTO `cons_itc_aut_active` 
        (`id`, `id_cons_itc`,
        /*Mobil Medical*/
       ...
       */
      $sql_authorization_passive = "INSERT INTO `cons_itc_aut_passive` 
      (`id`, `id_cons_itc`, 
      /*ADMIN*/
     ...
     */
    $sql_authorization_temporary = "INSERT INTO `cons_itc_aut_temporary` 
    (`id`, `id_cons_itc`, 
    `new_bulding`, 
