<?php
        if($id_cons == "MAT-ITC"){
            ...
            $categories = "It & Communications Materials";
            ...
            $affiche_name= $requete_affiche_name->fetch();    
                ...
                $id_code = $affiche_name["id_code_mat_itc"];
            ...
            $affiche_location = $requete_affiche_location ->fetch();
                ...
                // MODIF LOCA
                    // MAIN
                    $link_man_loc_1 = "locations_mat_itc/locations/list_locations_1.php"; $link_man_loc_2 = "locations_mat_itc/locations/list_locations_2.php";
                    $id_locations_0 = $affiche_location["location"];
                    if($id_locations_0 !="" &&  $id_locations_0 != 0){
                        $sql_edit_locations_0 = "SELECT * FROM `mat_location_itc` WHERE `id_location` = $id_locations_0";
                    ...
                    // SUB
                    $link_sub_loc_1 = "locations_mat_itc/sublocations/list_sublocations_1.php"; $link_sub_loc_2 = "locations_mat_itc/sublocations/list_sublocations_2.php";
                    $id_locations_1 = $affiche_location["sub_location"];
                    if($id_locations_1 !="" &&  $id_locations_1 != 0){
                        $sql_edit_locations_1 = "SELECT * FROM `mat_sublocation_itc` WHERE `id_sub_loc` = $id_locations_1";
                    ...
                    // SUB SUB
                    $link_sub_sub_loc_1 = "locations_mat_itc/subsublocations/list_subsublocations_1.php" ; $link_sub_sub_loc_2 ="locations_mat_itc/subsublocations/list_subsublocations_2.php";
                    $id_locations_2 = $affiche_location["sub_sub_location"];
                    if($id_locations_2 !="" And  $id_locations_2 != 0){
                        $sql_edit_locations_2 = "SELECT * FROM `mat_subsublocation_itc` WHERE `id_subsubloc` = $id_locations_2";
