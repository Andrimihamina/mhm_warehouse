...
// LOCATION 0
     ...
     $sql_edit_locations_0 = "SELECT * FROM cons_tec_location JOIN cos_log_location ON cons_tec_location.location = cos_log_location.id_location  WHERE cons_tec_location.location = '$id_locations_0'";
...
// LOCATION 1
     ...
     $sql_edit_locations_1= "SELECT * FROM cons_tec_location JOIN cos_log_sublocation ON cons_tec_location.sub_location = cos_log_sublocation.id_sub_loc  WHERE cons_tec_location.sub_location= '$id_locations_1'";
...
// LOCATION 2
     ...
     $sql_edit_locations_2= "SELECT * FROM cons_tec_location JOIN cos_log_subsublocation ON cons_tec_location.sub_sub_location = cos_log_subsublocation.id_subsubloc  WHERE cons_tec_location.sub_sub_location= '$id_locations_2'";
