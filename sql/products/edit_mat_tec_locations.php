...
// LOCATION 0
     $id_locations_0 = $prod["id_mat_tec"];  
     if($id_locations_0 !="" and  $id_locations_0 !=0){
     $sql_edit_locations_0 = "SELECT * FROM mat_tec_id 
                                        JOIN mat_tec_location ON mat_tec_location.id_mat_tec = mat_tec_id.id  
                                        JOIN mat_location_tec ON mat_tec_location.location = mat_location_tec.id_location  
                                        WHERE mat_tec_id.id = '$id_locations_0'";
...
// LOCATION 1
     $id_locations_1= $prod["id_mat_tec"];  
     if($id_locations_1!="" and  $id_locations_1!=0){
     $sql_edit_locations_1= "SELECT * FROM mat_tec_id 
                                        JOIN mat_tec_location ON mat_tec_location.id_mat_tec = mat_tec_id.id  
                                        JOIN mat_sublocation_tec ON mat_tec_location.sub_location = mat_sublocation_tec.id_sub_loc  
                                        WHERE mat_tec_id.id = '$id_locations_1'";
...
// LOCATION 2
     $id_locations_2= $prod["id_mat_tec"];  
     if($id_locations_2!="" and  $id_locations_2!=0){
     $sql_edit_locations_2= "SELECT * FROM mat_tec_id 
                                        JOIN mat_tec_location ON mat_tec_location.id_mat_tec = mat_tec_id.id  
                                        JOIN mat_subsublocation_tec ON mat_tec_location.sub_sub_location = mat_subsublocation_tec.id_subsubloc  
                                        WHERE mat_tec_id.id = '$id_locations_2'";
