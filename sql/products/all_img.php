...
// MEDICALS
     // MEDICINE
     $sql_prods_med= "SELECT medicine_id.id,medicine_id.id_code_med, medicine_id.Descriptions, medicine_id.med_img,  medicine_quantity.stock
                         FROM medicine_id
     ...
     // CONSUMABLE 
     $sql_prods_cons_med= "SELECT cons_med_id.id,cons_med_id.id_code_cons_med, cons_med_id.Descriptions, cons_med_id.cons_image, cons_med_quantity.stock
                                   FROM cons_med_id
     ...
     // MATERIALS 
     $sql_prods_mat_med= "SELECT mat_med_id.id,mat_med_id.id_code_mat_med, mat_med_id.Descriptions ,mat_med_id.mat_med_image , mat_med_quantity.stock
                                   FROM mat_med_id
...
// LOGISTICS
      // CONSUMABLE 
      $sql_prods_cons_log= "SELECT cons_log_id.id,cons_log_id.id_code_cons_log, cons_log_id.Descriptions, cons_log_id.image, cons_log_quantity.stock
                                   FROM cons_log_id
