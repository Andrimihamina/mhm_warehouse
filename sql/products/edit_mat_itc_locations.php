...
// LOCATION 0
     $id_locations_0 = $prod["id_mat_itc"];  
     if($id_locations_0 !="" and  $id_locations_0 !=0){
     $sql_edit_locations_0 = "SELECT * FROM mat_itc_id 
                                        JOIN mat_itc_location ON mat_itc_location.id_mat_itc = mat_itc_id.id  
                                        JOIN mat_location_itc ON mat_itc_location.location = mat_location_itc.id_location  
                                        WHERE mat_itc_id.id = '$id_locations_0'";
...
// LOCATION 1
     $id_locations_1= $prod["id_mat_itc"];  
     if($id_locations_1!="" and  $id_locations_1!=0){
     $sql_edit_locations_1= "SELECT * FROM mat_itc_id 
                                        JOIN mat_itc_location ON mat_itc_location.id_mat_itc = mat_itc_id.id  
                                        JOIN mat_sublocation_itc ON mat_itc_location.sub_location = mat_sublocation_itc.id_sub_loc  
                                        WHERE mat_itc_id.id = '$id_locations_1'";
...
// LOCATION 2
     $id_locations_2= $prod["id_mat_itc"];  
     if($id_locations_2!="" and  $id_locations_2!=0){
     $sql_edit_locations_2= "SELECT * FROM mat_itc_id 
                                        JOIN mat_itc_location ON mat_itc_location.id_mat_itc = mat_itc_id.id  
                                        JOIN mat_subsublocation_itc ON mat_itc_location.sub_sub_location = mat_subsublocation_itc.id_subsubloc  
                                        WHERE mat_itc_id.id = '$id_locations_2'";
