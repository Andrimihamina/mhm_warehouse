...
// LOCATION 0
     $id_locations_0 = $prod["id_mat_med"];  
     if($id_locations_0 !="" and  $id_locations_0 !=0){
     $sql_edit_locations_0 = "SELECT * FROM mat_med_id 
                                        JOIN mat_med_location ON mat_med_location.id_mat_med = mat_med_id.id  
                                        JOIN mat_location ON mat_med_location.location = mat_location.id_location  
                                        WHERE mat_med_id.id = '$id_locations_0'";
...
// LOCATION 1
     $id_locations_1= $prod["id_mat_med"];  
     if($id_locations_1!="" and  $id_locations_1!=0){
     $sql_edit_locations_1= "SELECT * FROM mat_med_id 
                                        JOIN mat_med_location ON mat_med_location.id_mat_med = mat_med_id.id  
                                        JOIN mat_sublocation ON mat_med_location.sub_location = mat_sublocation.id_sub_loc  
                                        WHERE mat_med_id.id = '$id_locations_1'";
...
// LOCATION 2
     $id_locations_2= $prod["id_mat_med"];  
     if($id_locations_2!="" and  $id_locations_2!=0){
     $sql_edit_locations_2= "SELECT * FROM mat_med_id 
                                        JOIN mat_med_location ON mat_med_location.id_mat_med = mat_med_id.id  
                                        JOIN mat_subsublocation ON mat_med_location.sub_sub_location = mat_subsublocation.id_subsubloc  
                                        WHERE mat_med_id.id = '$id_locations_2'";
