...
// LOCATION 0
     ...
     $sql_edit_locations_0 = "SELECT * FROM cons_med_location JOIN med_location ON cons_med_location.location_0 = med_location.id_location  WHERE cons_med_location.location_0 = '$id_locations_0'";
...
// LOCATION 1
     ...
     $sql_edit_locations_1= "SELECT * FROM cons_med_location JOIN med_sublocation ON cons_med_location.location_1= med_sublocation.id_sub_loc  WHERE cons_med_location.location_1= '$id_locations_1'";
...
// LOCATION 2
     ...
     $sql_edit_locations_2= "SELECT * FROM cons_med_location JOIN med_subsublocation ON cons_med_location.location_2= med_subsublocation.id_subsubloc  WHERE cons_med_location.location_2= '$id_locations_2'";
