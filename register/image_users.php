<?php
    ...
    $file_tmp_name = $_FILES["users_img"]["tmp_name"];
    ...
    switch($infos["mime"]){
        case "image/png":
            ...
            imagepng($nouvelleImage, __DIR__ . "/../../warehouse_img/img/users_img/users-img-". $file_name);
            break;
        case "image/jpeg":
            //On enregistre l'image
            imagejpeg($nouvelleImage, __DIR__ . "/../../warehouse_img/img/users_img/users-img-". $file_name);
            break;     
    }
