...
<?php
    // LINK DYNAMIQUE
      $link_dynamique = "medicals/materials/authorizations/9_ministry.php";
    // LINK EDIT
      $link_edit = "edit_mat_med_id.php";
    // LINK AUTHORIZATIONS
      $link_authorization ="edit_mat_med_aut_active.php";
      $id ="id_code_mat_med";
      $id_id ="id_mat_med";
...
<!-- BODY -->
<?php require_once ("layout_cons/f_9_ministry.php");?>
