...
<?php
    // LINK DYNAMIQUE
      $link_dynamique = "foods/consumables/authorizations/15_technical.php";
    // LINK EDIT
      $link_edit = "edit_cons_foo_id.php";
    // LINK AUTHORIZATIONS
      $link_authorization ="edit_cons_foo_aut_passive.php";
      $id ="id_code_cons_foo";
      $id_id ="id_cons_foo";
...
<!-- BODY -->
<?php require_once ("layout_cons/f_15_technicals.php");?>
