...
<?php
 ...
 require_once ("../../php/products_edit/medicals/medicines/authorizations/delivery.php");
 ?>
...
<div class="col-lg-12">
  ...
  ?>
    <tr>   
        ...
        <!-- DELIVERY -->
        <td><div class="form-check"><input class="form-check-input" type="checkbox" name="inpatients_delivery-<?=strip_tags($prod_med["id_med"])?>" value="1"  id="inpatients_delivery" <?php $inpatients_delivery = $edits_aut_active[0]["inpatients_delivery"];if($inpatients_delivery =="1"){echo"checked";}?>></div></td>
        <!-- EDIT -->
