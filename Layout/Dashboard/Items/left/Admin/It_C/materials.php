 <!-- START MATERIALS IT And communications -->
 <div class="col-xxl-4 col-md-8">
  <div class="card info-card sales-card">
    <div class="card-body">
        <h5 class="card-title">It & Com<span>| Materials</span></h5>
          ...
          <div class="d-flex align-items-center">
            ...
            <!-- NUMBER OF THE TYPE -->
              <a href="../../Layout/products_all/prod_mat_itc.php">
                ...
                <div class="ps-3"><h6><?=$Nbr_Type_mat_itc;?></h6>
              </a>
            ...
            <!-- PROSPECTING DE BESOIN -->
              <a href="../../Layout/Purchases/pros_mat_itc.php">
                ...
                <span class="text-<?=$madagasikara_mat_itc?> small pt-1 fw-bold">Madagaskar</span>
              </a>
              </br>
              <a href="../../Layout/Purchases/pros_mat_itc.php">
                <!-- FROM GERMANY -->
                ...
                <span class="text-<?=$germany_mat_itc?> small pt-1 fw-bold">Germany</span>
              </a>
...
<!-- END MATERIALS IT and Communication -->