  ...
  <div class="card mb-3">
    ...
    <div class="col-md-4">
      <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
        <img src="../../../warehouse_img/img/<?=$link_img;?>/<?=$image;?>" class="img-fluid rounded-start" alt="IMG">
      ...
      <div class="col-md-8">
          <p class="card-text">
            <div class="alert alert-primary alert-dismissible fade show" role="alert">
              ...
              <hr>
              <p class="mb-0">Used For : <?=$Used?></p>
              <hr>
              <p class="mb-0">Location    : <?=$locations?></p>
              <hr>
              <p class="mb-0">Prices : <?=$qt?><?=$qt_units?> cost <?=$price?></p>
              <hr>
